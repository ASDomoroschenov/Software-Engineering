package ru.mai.lab1.controller;
...
@Tag(
    ...
    description = "Контроллер, позволяющий добавлять, изменять, получать и удалять информацию о студентах"
)
public interface StudentController {
  ...
  @PostMapping("/create")
  CreateStudentResponse createStudent(@RequestBody @Valid CreateStudentRequest request);
      ...
      responses = {
          @ApiResponse(
              ...
              content = @Content(
                  mediaType = "application/json",
                  array = @ArraySchema(
                      schema = @Schema(implementation = ReadStudentResponse.class)
                  )
              )
          ),
          @ApiResponse(
  ...
  @GetMapping("/read")
  ReadStudentResponse readStudent(@RequestParam("id") @NotNull Long id);
  ...
  @PutMapping("/update")
  UpdateStudentResponse updateStudent(@RequestBody @Valid UpdateStudentRequest request);
      ...
      responses = {
          @ApiResponse(
              ...
              content = @Content(
                  mediaType = "application/json",
                  array = @ArraySchema(
                      schema = @Schema(implementation = DeleteStudentResponse.class)
                  )
              )
          ),
          @ApiResponse(
  ...
  DeleteStudentResponse deleteStudent(@RequestParam("id") @NotNull Long id);
}
